...
@section('content')
    <div class="mall-list-toolbar d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
        <h2 class="h5 mb-0">赛事分组 (<code class="small">biz_game_group</code>)</h2>
        <a href="{{ route('admin.game-groups.create') }}" class="btn btn-primary btn-sm">新建</a>
    </div>

    <p class="text-muted small">分组与本地赛事 <code>biz_game</code> 为多对多；对外稳定代号为唯一字段 <code>code</code>（与 API <code>group_code</code> 筛选一致）。</p>
