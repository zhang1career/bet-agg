    ...
    <aside id="console-sidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-4 overflow-x-hidden">
            <ul class="space-y-1 px-3">
                <li>
                    <a href="{{ route('admin.sport-book.index') }}"
                       class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-700 transition-colors sidebar-link {{ request()->routeIs('admin.sport-book.*') ? 'bg-gray-700' : '' }}"
                       title="Sport book">
                        <svg class="w-5 h-5 flex-shrink-0 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                        </svg>
                        <span class="sidebar-text ml-3 whitespace-nowrap">Sport book</span>
                    </a>
                </li>
                <li>
